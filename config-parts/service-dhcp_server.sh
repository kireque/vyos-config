...
set service dhcp-server shared-network-name IOT subnet 10.1.3.0/24 static-mapping utility-room-slzb-05-01 ip-address '10.1.3.11'
set service dhcp-server shared-network-name IOT subnet 10.1.3.0/24 static-mapping utility-room-slzb-05-01 mac-address 'a8:48:fa:08:60:57'
set service dhcp-server shared-network-name IOT subnet 10.1.3.0/24 static-mapping utility-room-slzb-05-02 ip-address '10.1.3.12'
set service dhcp-server shared-network-name IOT subnet 10.1.3.0/24 static-mapping utility-room-slzb-05-02 mac-address '94:3c:c6:3b:c5:17'
...
# set service dhcp-server shared-network-name IOT subnet 10.1.3.0/24 static-mapping livingroom-atv ip-address '10.1.3.16'
# set service dhcp-server shared-network-name IOT subnet 10.1.3.0/24 static-mapping livingroom-atv mac-address 'a4:cf:99:eb:02:07'
