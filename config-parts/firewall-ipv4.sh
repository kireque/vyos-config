...
set firewall ipv4 name lan-iot rule 410 protocol 'tcp'                                              # temp rule
...
set firewall ipv4 name wan-lan rule 100 description 'Rule: accept_ingress_from_cloudflare'
set firewall ipv4 name wan-lan rule 100 destination group address-group 'docker_node'
set firewall ipv4 name wan-lan rule 100 destination port 'http,https'
set firewall ipv4 name wan-lan rule 100 protocol 'tcp'
set firewall ipv4 name wan-lan rule 100 source group network-group 'cloudflare-ipv4'
