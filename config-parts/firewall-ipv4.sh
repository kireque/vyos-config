...
set firewall name wan-lan rule 100 description 'Rule: accept_ingress_from_cloudflare'
set firewall name wan-lan rule 100 destination group address-group 'docker_node'
set firewall name wan-lan rule 100 destination port 'http,https'
set firewall name wan-lan rule 100 protocol 'tcp'
set firewall name wan-lan rule 100 source group network-group 'cloudflare-ipv4'
