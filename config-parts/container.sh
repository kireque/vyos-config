...
set container name pihole environment PIHOLE_DOMAIN value 'home.econline.nl'
...
set container name pihole environment REV_SERVER_DOMAIN value 'home.econline.nl'
...
set container name pihole volume certificate-pem source '/config/secrets/certs/_.econline.nl/combined.pem'
