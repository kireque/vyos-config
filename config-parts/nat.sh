...
set nat destination rule 102 destination address '!10.4.0.4'
set nat destination rule 102 destination port '53'
set nat destination rule 102 inbound-interface name 'eth0.40'
set nat destination rule 102 protocol 'tcp_udp'
set nat destination rule 102 translation address '10.4.0.4'
...
set nat destination rule 105 inbound-interface name 'eth0.10'
...
set nat destination rule 106 inbound-interface name 'eth0.20'
...
set nat destination rule 107 inbound-interface name 'eth0.40'
